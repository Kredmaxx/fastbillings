...
const BottomBar: React.FC<BottomBarProps> = ({ isOpen = true, user, userName = "User" }) => {
  ...
  const collapsedBtn =
    "group relative flex h-11 w-11 items-center justify-center rounded-[14px] text-[#9BB0CC] bg-gradient-to-br from-white/[0.1] to-white/[0.03] ring-1 ring-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.12)] cursor-pointer transition-all duration-300 hover:text-white hover:scale-105 hover:ring-[#00C2FF]/45 hover:from-[#007BFF]/35 hover:to-[#00C2FF]/20 hover:shadow-[0_0_0_1px_rgba(0,210,255,0.25),0_8px_20px_rgba(0,123,255,0.25)]";

  const btn =
    "flex h-9 w-9 items-center justify-center rounded-xl text-[#8BA3C7] bg-white/[0.06] border border-white/10 cursor-pointer transition hover:bg-gradient-to-br hover:from-[#00C2FF] hover:to-[#007BFF] hover:text-white hover:border-transparent hover:shadow-[0_6px_18px_rgba(0,123,255,0.4)]";
      ...
      <div className="relative border-t border-white/[0.08] bg-[#060F24]/80 px-1.5 py-3 backdrop-blur-md">
        <div className="flex flex-col items-center gap-2.5">
          <button
            ...
            className={`${collapsedBtn} overflow-hidden bg-gradient-to-br from-[#007BFF] to-[#00C2FF] text-white ring-[#00C2FF]/30 shadow-[0_6px_16px_rgba(0,123,255,0.4)]`}
          >
  ...
  return (
    <div className="relative border-t border-white/[0.08] bg-gradient-to-r from-[#060F24]/90 via-[#0B1533]/80 to-[#060F24]/90 px-3 py-3 backdrop-blur-md">
      <div className="mb-2.5 flex items-center gap-2.5 rounded-xl border border-white/10 bg-white/[0.05] p-2.5">
        <div className="flex h-9 w-9 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-gradient-to-br from-[#007BFF] to-[#00C2FF] text-sm font-bold text-white shadow-[0_4px_14px_rgba(0,123,255,0.45)] ring-1 ring-white/20">
          {user?.profileImageUrl ? (
            <img src={user.profileImageUrl} alt="" className="h-full w-full object-cover" />
          ) : (
            initials

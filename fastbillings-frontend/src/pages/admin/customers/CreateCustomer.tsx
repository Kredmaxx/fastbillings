            ...
            <form className="space-y-8" onSubmit={handleSubmit}>
                <section>
                    ...
                    <div className="mb-6 flex items-center gap-5">
                        ...
                        <div className="relative w-14 h-14 overflow-hidden bg-gray-100  flex items-center justify-center shadow-inner rounded-sm">
                        ...
                        <div className="flex flex-col gap-2">
                            <button type="button" onClick={handleUploadClick} className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-purple-600 rounded-md shadow-sm hover:bg-gray-950 focus:outline-none focus:ring-1 focus:ring-offset-1 focus:ring-purple-600 cursor-pointer">

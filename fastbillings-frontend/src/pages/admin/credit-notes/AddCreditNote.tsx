    ...
    const handleCustomerChange = async (user: Customer) => {
        if (user) {
            ...
            setInvoiceFormData(prev => ({
                ...prev,
                billTo: user.id,
                // Only apply customer currency when no parent invoice is linked
                currencyCode: prev.invoiceId
                    ? prev.currencyCode
                    : (user.currencyCode || prev.currencyCode),
            }));
            ...
            <form onSubmit={saveCreditNote}>
                <div className="max-w-7xl mx-auto space-y-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                        <h1 className="text-2xl font-bold text-gray-950 ">New Credit Note</h1>
                ...
                <div className="flex justify-end mt-4 gap-3">
                    <button type='button' onClick={() => navigate('/admin/credit-notes')} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50    cursor-pointer">Cancel</button>

    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-950 ">Credit Notes</h1>
                {hasPermission(permissions, 'credit-notes', 'create') &&
                    <button
                        ...
                        <CirclePlusIcon size={14} /> New Credit Note
                    </button>
                }
            </div>
            ...
            <Table headers={tableHeaders}>
                {!isLoading && invoices && invoices.map((invoice, index) => (
                    <TableRow
                        ...
                        onRowClick={(item) => navigate(`/admin/credit-notes/edit/${item.id}`)}
                    />
                ))}

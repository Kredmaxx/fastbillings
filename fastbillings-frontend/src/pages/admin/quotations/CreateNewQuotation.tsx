...
const CreateNewQuotation: React.FC = () => {
    ...
    const { subTotal, totalTax, totalDiscount, grandTotal } = useMemo(() => {
        ...
        setQuotationFormData(prev => ({ ...prev, subTotal: totals.subTotal, totalTax: totals.totalTax, totalDiscount: totals.totalDiscount, grandTotal: grandTotalInteger }));
            ...
            <form>
                <div className="max-w-7xl mx-auto space-y-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                        <h1 className="text-2xl font-bold text-gray-950 ">New Quotation</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="bg-white  p-4 rounded-lg border border-gray-200 ">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="mt-2 text-xs text-gray-500  p-2 bg-gray-50  rounded-md font-semibold">

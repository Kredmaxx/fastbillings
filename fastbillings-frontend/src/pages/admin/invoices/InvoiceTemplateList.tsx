...
import invoice6 from "@assets/invoices/invoice-6.png";
import invoice7 from "@assets/invoices/invoice-7.png";
import invoice8 from "@assets/invoices/invoice-8.png";
import invoice9 from "@assets/invoices/invoice-9.png";
...
const templates: InvoiceTemplate[] = [
    ...
    { id: 3, name: "GST Tax Invoice (Classic)", image: invoice3 },
    { id: 4, name: "GST Tax Invoice (Modern)", image: invoice4 },
    { id: 5, name: "GST Tax Invoice (Compact)", image: invoice5 },
    { id: 6, name: "Commercial Bordered", image: invoice6 },
    { id: 7, name: "GST Formal (Yellow)", image: invoice7 },
    { id: 8, name: "GST E-Way / IRN", image: invoice8 },
    { id: 9, name: "GST Corporate", image: invoice9 },
];
        ...
        <div className="p-6">
            <div className="mb-6">
                ...
                <p className="text-gray-500 text-sm mt-1">
                    Choose a layout for printed invoices. Templates 3–5 and 7–9 are India GST-compliant; 6 is a classic commercial bordered style.
                </p>
            </div>

            ...
            <form onSubmit={savePurchaseOrder}>
                <div className="max-w-7xl mx-auto space-y-4">
                    ...
                    <div className="flex justify-between items-center mb-2">
                        <h1 className="text-2xl font-bold text-gray-950 ">Edit Purchase Order</h1>
                        {systemSettings?.company?.siteLogo && <img src={systemSettings?.company.siteLogo} alt="" className='w-32' />}
                    </div>
                ...
                <div className="flex justify-end mt-4 gap-3">
                    <button type='button' onClick={() => navigate('/admin/purchase-orders')} className="px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md hover:bg-gray-50 cursor-pointer">Cancel</button>

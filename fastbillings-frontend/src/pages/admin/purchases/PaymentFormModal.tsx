        ...
        <Modal isOpen={isOpen} onClose={onClose} title={'Add New Payment'} size="3xl">
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    {/* Purchase ID */}
                    <div>
                        <label className="block text-sm font-medium text-gray-700 ">Purchase ID <span className="text-red-500">*</span></label>
                        <SmartDropdown
                    ...
                    <div>
                        ...
                        <input type="number" value={formData.amount} readOnly className="mt-1 border border-gray-300 rounded-md px-3 py-2 w-full read-only:bg-gray-100   text-gray-950 " />
                    ...
                    <div>
                        ...
                        <SmartDropdown
                            ...
                            serverside={false}
                        />
                        {errors.sourceType && <p className="text-red-500 text-sm">{errors.sourceType}</p>}
                    </div>
                    {/* Bank account */}
                    ...
                    <div className="md:col-span-3">
                        ...
                        <textarea value={formData.notes} onChange={(e) => handleFormChange('notes', e.target.value)} rows={2} className="mt-1 border border-gray-300 rounded-md px-3 py-2 w-full  text-gray-950  focus:outline-none focus:ring-1 focus:ring-purple-600"></textarea>
                    </div>

                    {/* Attachment */}
                    <div className="md:col-span-3">
                        <label className="block text-sm font-medium text-gray-700 ">Attachment</label>
                        <div className="mt-1 flex justify-center px-4 pt-5 pb-4 border-2 border-gray-300  border-dashed rounded-md">
                            <div className="space-y-1 text-center">
                                {/* <UploadCloud className="mx-auto h-12 w-12 text-gray-400" /> */}
                                <div className="flex text-sm text-gray-600 ">
                                    <label htmlFor="attachment" className="relative cursor-pointer bg-white  rounded-md font-medium text-purple-600 hover:text-purple-600">
                        ...
                        {formData.attachment && <p className="mt-2 text-sm text-gray-500 ">Selected: {formData.attachment.name}</p>}
                    </div>
                </div>

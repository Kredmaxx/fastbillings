...
const UserList: React.FC = () => {
    ...
    const tableActions = [
        {
            ...
            isDisabled: (item: StaffList) =>
                item.user_type === USER_TYPE.SUPER_ADMIN || item.user_type === USER_TYPE.ADMIN,
        },
        {
            label: 'Delete',
    ...
    const tableHeaders = ['#', 'User Name', 'Phone', 'Type', 'Role', 'Created On', 'Actions'];
        ...
        <div className="space-y-4">
            ...
            <Table headers={tableHeaders}>
                {!isLoading && staffs && staffs.map((staff: any, index: number) => (
                    <TableRow
                        ...
                        columns={[
                            ...
                            />,
                            staff.phone,
                            staff.userTypeLabel || staff.roleName,
                            staff.roleName,
                ...
                {!isLoading && !staffs.length &&
                    <tr>
                        <td colSpan={8} className="text-center text-gray-950  py-2 font-semibold">No Users Found</td>
                    </tr>
                }

...
const CostCenters: React.FC = () => {
    ...
    const tableActions = [
        { label: "Edit", icon: <Edit size={14} />, onClick: (item: ICostCenter) => openEdit(item) },
        { label: "Delete", icon: <Trash2 size={14} />, onClick: (item: ICostCenter) => handleDeleteClick(item) },
    ];
                        ...
                        <TableRow
                            ...
                            columns={[
                                ...
                                <label className="inline-flex items-center cursor-pointer">
                                    <input type="checkbox" className="sr-only peer" checked={item.isActive} onChange={() => updateActive(item)} />
                                    <div className="relative w-11 h-6 bg-gray-200 peer-checked:bg-purple-600 rounded-full peer-focus:ring-2 peer-focus:ring-purple-600">
                                        <div className={`absolute top-0.5 left-0.5 w-5 h-5 bg-white rounded-full shadow-md transform transition-transform ${item.isActive ? "translate-x-full" : ""}`}></div>
                                    </div>
                                </label>,
                            ]}

    ...
    return (
        <div className="space-y-5">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-800">New Journal Entry</h1>
            </div>

            <div className="bg-white rounded-md border border-gray-100 p-5 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label className="block text-sm text-gray-700 mb-1">Entry Date *</label>
                        <input
                            type="date"
                            value={entryDate}
                ...
                <div>
                    <div className="flex justify-between items-center mb-2">
                        ...
                        <button
                            type="button"
                            onClick={addLine}
                            className="inline-flex items-center gap-1 px-3 py-1.5 rounded-md bg-purple-600 text-white text-sm hover:bg-purple-700"
                        >
                        ...
                        <tbody>
                            ...
                            <tr className="bg-gray-50 font-medium">
                                ...
                                <td className="px-2 py-2" colSpan={2}>
                                    <span
                                        className={
                                            "inline-flex items-center px-2 py-1 rounded-sm text-xs font-semibold " +

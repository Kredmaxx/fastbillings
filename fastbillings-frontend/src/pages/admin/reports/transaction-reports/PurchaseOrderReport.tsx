    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <h1 className="text-2xl font-bold text-gray-600"> Purchase Order Report </h1>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <ChartCard title="Total Purchase Orders" value={totalDisplay(chartData?.totalOrders.totalAmount || 0)} color="#8b5cf6" />
                <ChartCard title="Completed Orders" value={totalDisplay(chartData?.completedOrders.totalAmount || 0)} color="#22c55e" />
                <ChartCard title="Pending Orders" value={totalDisplay(chartData?.pendingOrders.totalAmount || 0)} color="#eab308" />
                <ChartCard title="Cancelled Orders" value={totalDisplay(chartData?.cancelledOrders.totalAmount || 0)} color="#ef4444" />
            </div>
            {/* Filters*/}

    ...
    return (
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <ChartCard title="This Month Return" value={totalDisplay(chartData?.TotalDebit.currentMonthAmount || 0)} color="#8b5cf6" />
                <ChartCard title="Last Month Return" value={totalDisplay(chartData?.TotalDebit.previousMonthAmount || 0)} color="#22c55e" />
                <ChartCard title="Total Return" value={totalDisplay(chartData?.TotalDebit.allMonthAmount || 0)} color="#eab308" />
            </div>
            {/* Filters*/}
